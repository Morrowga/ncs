...
class Helper
{
    ...
    public static function sensitive_keywords($id)
    {
        $sensitive_keywors = array(
            'telenor', 'Telenor', 'တယ်လီနော', 'ooredoo', 'Ooredoo', 'အော်ရီဒူး', 'mytel', 'Mytel', 'မိုင်တဲ', 'mectel', 'Mectel', 'ကမ်းရိုးတန်းဖုန်းနံပါတ်', '18+', '၁၈+', 'fuck', 'Fuck', 'လိင်ဆက်ဆံ', 'လိင်', 'sex', 'suck', 'dick', 'shit', 'ဖောင်းဒိုင်း', 'Sexual', 'sexual', 'sexuality', 'Sexuality',
        );
        $sensitive_list = [];
        $raws = RawArticle::find($id);
        $contents = Content::where('article_id', $raws->id)->get();
    ...
    public static function suggest_category($id)
    {
        $sample_category = [
            ...
            ['indoor', 'plants', 'ခွေး', 'ဘာသာစကား', 'ပညာရေး', 'ကျောင်း', 'ပန်းချီ', 'မြစ်', 'လောက', 'လွယ်ကူလေ့လာ', 'အကျိူးကျေးဇူးများ', 'စကားလုံး', 'ကဗျာ', 'တိရိစ္ဆာန်', 'စာလုပ်', 'ဘုန်းကြီးကျောင်း', 'တိရစ္ဆာန်များ', 'သမုဒ္ဒရာ'], //other
