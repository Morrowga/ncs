...
class Helper
{
    ...
    public static function suggest_category($id)
    {
        ...
        $entertainment = [
            'Kpop', 'K-pop', 'K-POP', 'KDrama', 'Idol', 'မင်းသား', 'မင်းသမီး', 'Aespa', 'Girl Group',
        ...
        $beauty = [
            'ဖက်ရှင်', 'fashion', 'မိန်းကလေး', 'အသားအရေ', 'မိတ်ကပ်', 'Mask', 'ဆံသား', 'ပေါင်းတင်နည်း', 'လက်သည်းနီ', 'Makeup',
            'ဆံပင်', 'ဆံကေသာ', 'အလှအပ', 'Aerobic', 'လက်သည်း', 'မျက်နှာ', 'မျက်တောင်', 'နှုတ်ခမ်းနီ', 'တံတောင်ဆစ်', 'လက်စွပ်', 'အိတ်', 'EyeShadow', 'မီးခိုးရောင်', 'အညိုရောင်', 'သွားတိုက်ဆေး', 'အပြာရောင်', 'အလှအပရေးရာ', 'dress', 'crop top', 'အဆီဖု', 'ဘောင်းဘီ', 'အပြုံး', 'အင်္ကျီ', 'freestyle', 'ဝမ်းဆက်', 'ဒေါက်ဖိနပ်', 'accessories', 'အမဲ', 'ပန်းရောင်', 'ရှင်းရှင်းလေးနဲ့လှ', 'အဖြူရောင်', 'ပေါ့ပေါ့ပါးပါးလေး', 'လှလှ', 'အကောက်', 'အလှပဂေး', ' Body Fit', 'powder', 'sunscreen', 'အသားခြောက်', 'Glow', 'အရမ်းလှ', 'ဆံသား', 'ယောဂ', 'စတိုင်လ်', 'လေ့ကျင့်ခန်း', 'ပြုလုပ်ပေးရမယ့်အရာများ', 'workout', 'ကိုယ်အလေးချိန်', 'အလေးချိန်', 'ပို့စ်', 'Exercise', 'Photo', 'photo', 'ဝက်ခြံ', 'glow', 'အလှကုန်', 'လိမ်းခြယ်နည်း', 'ဒီဇိုင်း', 'scrub', 'Scrub', 'နုပျိုလှပ', 'skincare', 'Skincare', 'ပိုင်ဆိုင်'
        ];
        $health = ['ဓမ္မတာ', 'အောက်စီဂျင်', 'ကိုဗစ်', 'ရောဂါ', 'ကိုယ်ဝန်ဆောင်', 'နာတာရှည်', 'ဒူးနာ', 'ခါးနာ', 'ကျန်းမာရေးဆိုင်ရာကောင်းကျိုးများ', 'လေထိုးလေအောင့်', 'ထိပ်ပြောင်', 'ထိပ်မပြောင်', 'ချောင်းဆိုး', 'ဒဏ်ရာ', 'ထိခိုက်ဒဏ်ရာ', 'မျက်လုံးလေ့ကျင့်ခန်း', 'နာကျင်ခြင်း', 'တုပ်ကွေး', 'ခံတွင်းနံ့နံ'];
