...
class Helper
{
    ...
    public static function suggest_category($id)
    {
        ...
        $health = ['အောက်စီဂျင်', 'ကိုဗစ်', 'ရောဂါ', 'ကိုယ်ဝန်ဆောင်', 'နာတာရှည်', 'ဒူးနာ', 'ခါးနာ', 'ကျန်းမာရေးဆိုင်ရာကောင်းကျိုးများ', 'လေထိုးလေအောင့်', 'ထိပ်ပြောင်', 'ထိပ်မပြောင်', 'ချောင်းဆိုး', 'ဒဏ်ရာ', 'ထိခိုက်ဒဏ်ရာ', 'မျက်လုံးလေ့ကျင့်ခန်း', 'နာကျင်ခြင်း', 'တုပ်ကွေး'];
