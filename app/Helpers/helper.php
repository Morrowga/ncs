...
class Helper
{
    ...
    public static function suggest_category($id)
    {
        ...
        $entertainment = ['Kpop', 'K-POP', 'KDrama', 'Idol', 'မင်းသား', 'မင်းသမီး', 'Aespa', 'Girl Group', 'Kim Sae Ron', 'သရုပ်ဆောင်', 'Jennie', 'Jung Ho Yeon', 'ကေပေါ့', 'အိုင်ဒေါ', 'ရုပ်ရှင်', 'BIGBANG', 'Netflix', 'ဇာတ်လမ်း', 'အနုပညာ', 'ဇာတ်ကောင်', 'ဟောလိဝုဒ်', 'သီချင်းသစ်', 'seventeen', 'သီချင်း', 'Idol', 'Drama', 'Han So Hee', 'Cele', 'Bieber', 'အဖွဲ့', 'ပရိသတ်တွေရဲ့', 'TWICE', 'Bambi Zhu', 'Kylie Jenner', 'Kendall Jenner', 'စူပါမော်ဒယ်'];
