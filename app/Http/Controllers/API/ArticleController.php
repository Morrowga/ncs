    ...
    public function get_trend()
    {
        ...
        if ($category_name) {
            ...
            $articles_one = DB::table('raw_articles')
                ...
                ->where([['raw_articles.update_status', '1'], ['raw_articles.sent_status', '1'], ['raw_articles.category_id', $category_id], ['raw_articles.publishedDate', '>=', $time_one]])
            ...
            $articles_two = DB::table('raw_articles')
                ->join('article_records', 'raw_articles.id', '=', 'article_records.article_id')
                ->where([['raw_articles.update_status', '1'], ['raw_articles.sent_status', '1'], ['raw_articles.category_id', $category_id], ['raw_articles.publishedDate', '<=', $time_one], ['raw_articles.publishedDate', '>=', $time_two]])
                ->orderByDesc('article_records.view_count')
                ->select('raw_articles.id', 'raw_articles.uuid', 'article_records.view_count')
                ->get();
        } else {
