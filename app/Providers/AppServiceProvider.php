...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        $count_raw_article = RawArticle::where('status', 0)->count();
        $count_sent_lotaya = RawArticle::where('status', 1)->count();
        $count_reject_article = RawArticle::where('status', '>', 1)->count();
