...
<div class="col-12">
    <div class="d-flex">
        <h1 class="page-title mb-2 mr-auto">{{ __('Reject Article List') }}</h1>
            ...
            <div class="card shadow">
                <div class="card-body px-0 pb-0">
                    ...
                    <div class="toolbar px-2 px-md-3">
                        <form class="form" action="{{ route('reject_articles.index') }}" method="GET">
                            <div class="form-row">
                                ...
                                class="btn btn-outline-primary rounded-0"><i class="fe fe-plus-square fe-16"></i>
                                {{ __('Create') }}</a>
                            </div> --}}
                    </div>
                    </form>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            @forelse ($reject_articles as $reject)
                            <tr>
                                <td>{{ $reject->id }}</td>
                                <td>{{ $reject->uuid }}</td>
                            ...
                            @empty
                            <tr>
                                <th colspan="5" class="text-center">No Reject Data ..</th>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
