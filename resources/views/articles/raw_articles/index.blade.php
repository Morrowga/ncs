...
<div class="col-12">
    <div class="d-flex">
        <h1 class="page-title mb-2 mr-auto">{{ __('Raw Article') }}</h1>
            ...
            <div class="card shadow">
                <div class="card-body px-0 pb-0">
                    ...
                    <div class="toolbar px-2 px-md-3">
                        <form class="form" action="{{ route('raw_articles.index') }}" method="GET">
                            <div class="form-row">
                                ...
                                <div class="form-group col-auto ml-md-auto">
                                    <a href="{{ route('raw_articles.create') }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#delete-modal" data-toggle="modal"
                                            ...
                                            data-route="{{ route('raw_articles.destroy', $raw->id) }}"><i
