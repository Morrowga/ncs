...
<div class="col-12">
    ...
    <form action="{{ route('itemschema.update',$itemschema->id) }}" method="POST" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
        <div class="form-group row">
            <label for="title" class="col-sm-3 col-form-label">{{ __('Item Schema Title') }}</label>
            <div class="col-sm-9">
                <input type="text" name="title" class="form-control" id="title" value="{{ $itemschema->title }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" name="css_expression" class="form-control" id="css_expression"
                    value="{{ $itemschema->css_expression }}" placeholder="{{ __('Item Schema css_expression') }} ..">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" name="full_content_selector" class="form-control" id="full_content_selector"
                    value="{{ $itemschema->full_content_selector }}"
